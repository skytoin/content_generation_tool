...
import { InkProjectDetail } from '@/components/themes/ink-diffusion'
import { DashboardHeader } from './DashboardHeader'
import { CopyButton, DownloadButton, DeleteButton, RegenerateButton } from './ProjectActions'
...
export function ProjectDetailWrapper({ project, instagramImages, isInstagram }: ProjectDetailWrapperProps) {
  ...
  const tierInfo = getTierBadge(project.tier || 'premium')
