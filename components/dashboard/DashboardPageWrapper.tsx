...
import { InkDashboardHome } from '@/components/themes/ink-diffusion'
import { DashboardHeader } from './DashboardHeader'
import Link from 'next/link'

interface DashboardPageWrapperProps {
  userName?: string
  stats: { name: string; value: number; icon: string }[]
  recentProjects: {
    id: string
    name: string
    serviceType: string
...
export function DashboardPageWrapper({ userName, stats, recentProjects }: DashboardPageWrapperProps) {
