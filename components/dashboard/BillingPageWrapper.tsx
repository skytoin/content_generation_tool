...
import { InkBilling } from '@/components/themes/ink-diffusion'
...
export function BillingPageWrapper({ subscriptionTier }: BillingPageWrapperProps) {
  const { uiMode } = useUIMode()

  if (uiMode === 'ink-diffusion') {
    return <InkBilling subscriptionTier={subscriptionTier} />
  }
