...
import { InkProjectsList } from '@/components/themes/ink-diffusion'
...
export function ProjectsPageWrapper({ projects }: ProjectsPageWrapperProps) {
  ...
  if (uiMode === 'ink-diffusion') {
    return <InkProjectsList projects={projects} />
  }
