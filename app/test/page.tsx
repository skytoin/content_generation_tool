          ...
          {activeTab === 'content' ? (
            <div className="bg-gray-800/80 backdrop-blur rounded-2xl shadow-2xl border border-gray-700/50 overflow-hidden">
              <div className="bg-gradient-to-r from-purple-900/50 to-blue-900/50 px-8 py-6 border-b border-gray-700/50">
                ...
                <p className="text-gray-400 mt-1">Generated by Scribengine • 8-Stage Premium Pipeline</p>
              </div>
...
export default function TestPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('scribengine_projects')
    if (saved) setProjects(JSON.parse(saved))
  }, [])

  useEffect(() => {
    localStorage.setItem('scribengine_projects', JSON.stringify(projects))
  }, [projects])
      ...
      <div className="w-72 bg-gray-800 border-r border-gray-700 flex flex-col">
        <div className="p-4 border-b border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">Scribengine</h1>
      ...
      {!activeProject ? (
        <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-900 to-purple-900/20">
          <div className="text-center max-w-md px-8">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">Welcome to Scribengine</h2>
